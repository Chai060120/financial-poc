...
class AppState:
    ...
    web_agent_hub: object | None = None
    ...
    def get_web_agent_hub(self):
        if self.web_agent_hub is None:
            from api.services.web_agent_service import WebAgentHub

            self.web_agent_hub = WebAgentHub()
        return self.web_agent_hub
